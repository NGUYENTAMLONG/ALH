...
export class AdminCreateCandidateDto {
  ...
  @IsString({
    message: 'Vui lòng nhập đúng định dạng chuỗi ký tự',
  })
  @IsOptional()
  note: string;
  ...
  @IsOptional()
  @IsArray({ message: 'Vui lòng nhập mức lương một mảng' })
  ...
  @IsArray({ message: 'Vui lòng nhập một mảng' })
  @IsOptional()
  @IsString({ each: true, message: 'Vui lòng nhập đúng định dạng chuỗi ký tự' })
  image_files: string[];

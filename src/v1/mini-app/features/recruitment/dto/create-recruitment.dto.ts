...
export class HROCreateRecruitmentWithEnterperiseDto {
  // @ApiProperty({
  //   required: true,
...
export class HROCreateRecruitmentDto {
  @ApiProperty({
    required: true,
    description: 'Id Công ty/Doanh nghiệp',
    example: '1',
  })
  @IsNotEmpty({ message: 'Thông tin công ty/doanh nghiệp là bắt buộc' })
